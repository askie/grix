// Package qoderclicn provides the Qoder CLI CN adapter.
//
// This CLI speaks the Agent Client Protocol, bridged by grix-connector's
// generic ACP adapter (client_type "qoderclicn", command `qoderclicn --yolo --acp`;
// Alibaba Qoder's CN-region distribution of the same product as qodercli).
