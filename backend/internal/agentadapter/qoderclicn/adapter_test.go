...
func TestFamilyAndID(t *testing.T) {
	a := newAdapter()
	if a.Family() != "qoderclicn" {
		t.Fatalf("Family() = %q, want %q", a.Family(), "qoderclicn")
	}
	if a.AdapterID() != "qoderclicn/base" {
		t.Fatalf("AdapterID() = %q, want %q", a.AdapterID(), "qoderclicn/base")
	}
}
...
func TestSupports(t *testing.T) {
	...
	tests := []struct {
		...
		{"client_type match", agentadapter.AgentClientMeta{ClientType: "qoderclicn"}, true},
		{"host_type match", agentadapter.AgentClientMeta{HostType: "qoderclicn"}, true},
		{"host_type priority", agentadapter.AgentClientMeta{ClientType: "hermes", HostType: "qoderclicn"}, true},
