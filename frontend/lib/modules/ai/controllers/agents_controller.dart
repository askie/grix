...
class AgentsController extends GetxController {
  ...
  String? _resolveClientTypeLabel(String raw) {
    switch (raw.trim().toLowerCase()) {
      ...
      case 'traecli':
        return 'ai_agent_client_type_traecli'.tr;
      case 'acp':
      ...
      case 'grok':
        return 'ai_agent_client_type_grok'.tr;
      case 'qwenpaw':
        return 'ai_agent_client_type_qwenpaw'.tr;
      case 'zeroclaw':
        return 'ai_agent_client_type_zeroclaw'.tr;
      default:
        return raw.trim();
    }
  }
