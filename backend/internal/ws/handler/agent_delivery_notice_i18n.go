...
type agentDeliveryFailureCopy struct {
	...
	// failedPrefix 前缀 + 连接器回报的原始失败原因摘要，只给主人看。
	failedPrefix string
}
...
var agentDeliveryFailureCopyByLanguage = map[string]agentDeliveryFailureCopy{
	...
	"en": {
		...
		failedPrefix:  "The agent failed to process this message: ",
	},
	"ja": {
	...
	"de": {
		...
		failedPrefix:  "Der Agent konnte die Nachricht nicht verarbeiten: ",
	},
	"fr": {
		...
		failedPrefix:  "L’agent n’a pas pu traiter le message : ",
	},
	"es": {
		...
		failedPrefix:  "El agente no pudo procesar el mensaje: ",
	},
	"pt": {
		...
		failedPrefix:  "O agente não conseguiu processar a mensagem: ",
	},
	"ru": {
		...
		failedPrefix:  "Агент не смог обработать сообщение: ",
	},
	"ar": {
		...
		failedPrefix:  "تعذّر على الوكيل معالجة الرسالة: ",
	},
	"hi": {
		...
		failedPrefix:  "एजेंट संदेश संसाधित नहीं कर सका: ",
	},
}
