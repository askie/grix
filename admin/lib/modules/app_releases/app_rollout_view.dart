...
class _AppRolloutViewState extends State<AppRolloutView> {
    ...
    return AdminScaffold(
      ...
      body: _loading
          ...
          : ListView.separated(
              ...
              itemBuilder: (_, i) =>
                  _RuleCard(rule: _rules[i], onChanged: _load),
            ),
    );
  }
  ...
  Future<void> _create(BuildContext context) async {
          ...
          children: [
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: '规则类型 (percentage / user_list)',
              ),
            ),
            ...
            TextField(
              ...
              maxLines: 3,
              decoration: const InputDecoration(
                labelText: '规则值 JSON (如 {"percent":10} 或 {"user_ids":[123]})',
              ),
            ),
            const SizedBox(height: 8),
            TextField(
    ...
    for (final c in [typeCtrl, valueCtrl, priorityCtrl]) {
      c.dispose();
    }
  }
}
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '值: ${rule.ruleValue} · 优先级: ${rule.priority}',
