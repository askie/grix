...
import 'web_app_badge_stub.dart'
    if (dart.library.js_interop) 'web_app_badge_web.dart'
    as web_app_badge;

class AppBadgeService {
  AppBadgeService._();

  static const MethodChannel _channel = MethodChannel('pub.dhf.grix/app_badge');
  ...
  static Future<void> syncUnreadBadge(
    ...
    try {
      await _channel.invokeMethod<void>('setAppBadge', {'count': normalized});
      _lastSyncedBadge = normalized;
