...
class ConnectorProblemUsersTab extends GetView<ConnectorProblemUsersController> {
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: IconButton(
                ...
                onPressed: () => controller.applyVersion(controller.versionCtrl.text),
              ),
            ),
    ...
    return Card(
      child: Obx(() => CheckboxListTile(
            ...
            subtitle: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('${u.failedHosts} 台机器 · ${u.agentIds.length} 个 Agent · ${u.lastReportedAt}',
                  ...
                  child: Wrap(spacing: 6, runSpacing: 4, children: [
                    for (final code in u.errorCodes)
                      Container(
                        ...
                        decoration: BoxDecoration(color: AppPalette.dangerSoft, borderRadius: BorderRadius.circular(4)),
                        child: Text(code, style: const TextStyle(fontSize: 11, color: AppPalette.danger)),
                      ),
                  ]),
                ),
            ]),
      ...
      return Material(
        ...
        child: Padding(
          ...
          child: Row(children: [
            ...
            Expanded(child: Text('已选 $count / 已加载 ${controller.items.length}（共 ${controller.total.value}）')),
            FilledButton.icon(
      ...
      builder: (ctx, setState) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 8),
            TextField(controller: body, maxLines: 6, decoration: const InputDecoration(labelText: '正文（支持 Markdown）')),
            const SizedBox(height: 12),
            Row(children: [
              OutlinedButton.icon(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      if (preview.emailError.isNotEmpty)
        Text(preview.emailError, style: const TextStyle(color: AppPalette.danger, fontSize: 12))
      else ...[
        ...
        Container(
          ...
          child: SelectableText(_stripHtml(preview.emailHtml), style: theme.textTheme.bodySmall),
        ),
      ],
      const SizedBox(height: 12),
      ...
      if (preview.smsError.isNotEmpty)
        Text('短信通道不可用：${preview.smsError}', style: const TextStyle(color: AppPalette.danger, fontSize: 12)),
      Container(
        width: double.infinity,
        padding: const EdgeInsets.all(10),
        decoration: BoxDecoration(color: AppPalette.infoSoft, borderRadius: BorderRadius.circular(6)),
        child: SelectableText(preview.smsText, style: theme.textTheme.bodySmall),
      ),
    ]);
  }
}
