...
class PhoneLoginController extends GetxController {
  ...
  static const List<({String code, String nameKey})> commonCountries = [
    (code: '+86', nameKey: 'phone_country_cn'),
    (code: '+852', nameKey: 'phone_country_hk'),
    (code: '+853', nameKey: 'phone_country_mo'),
    (code: '+886', nameKey: 'phone_country_tw'),
    (code: '+65', nameKey: 'phone_country_sg'),
    (code: '+60', nameKey: 'phone_country_my'),
    (code: '+81', nameKey: 'phone_country_jp'),
    (code: '+82', nameKey: 'phone_country_kr'),
    (code: '+1', nameKey: 'phone_country_us'),
    (code: '+44', nameKey: 'phone_country_gb'),
    (code: '+49', nameKey: 'phone_country_de'),
    (code: '+33', nameKey: 'phone_country_fr'),
    (code: '+61', nameKey: 'phone_country_au'),
    (code: '+64', nameKey: 'phone_country_nz'),
    (code: '+91', nameKey: 'phone_country_in'),
    (code: '+971', nameKey: 'phone_country_ae'),
    (code: '+966', nameKey: 'phone_country_sa'),
    (code: '+34', nameKey: 'phone_country_es'),
    (code: '+39', nameKey: 'phone_country_it'),
    (code: '+55', nameKey: 'phone_country_br'),
    (code: '+52', nameKey: 'phone_country_mx'),
  ];
