...
void main() {
  ...
  test('top-down diamond branch then merge keeps nodes separated', () {
    const diagram = ChatMermaidFlowchart(
      ...
      nodes: <ChatMermaidNode>[
        ChatMermaidNode(
            id: 'A', label: '开始', shape: ChatMermaidNodeShape.rounded, order: 0),
        ChatMermaidNode(
            id: 'B',
        ...
        ChatMermaidNode(
            ...
            order: 3),
        ChatMermaidNode(
            id: 'E', label: '结束', shape: ChatMermaidNodeShape.rounded, order: 4),
      ],
  ...
  test('top-down fan-out with three wide siblings keeps nodes separated', () {
    const diagram = ChatMermaidFlowchart(
      ...
      nodes: <ChatMermaidNode>[
        ChatMermaidNode(
            id: 'A', label: '入口', shape: ChatMermaidNodeShape.rounded, order: 0),
        ChatMermaidNode(
            id: 'B',
    ...
    const diagram = ChatMermaidFlowchart(
      ...
      nodes: <ChatMermaidNode>[
        ...
        ChatMermaidNode(
            ...
            order: 2),
        ChatMermaidNode(
            id: 'D', label: '完成', shape: ChatMermaidNodeShape.rounded, order: 3),
      ],
      edges: <ChatMermaidEdge>[
        ChatMermaidEdge(
            sourceId: 'A',
