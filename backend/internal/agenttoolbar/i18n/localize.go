...
var zhToEn = map[string]string{
	...
	"当前没有可用 Profile": "No profiles available",
	"创建会话前选择或新建 Profile；开始对话后不能再改":            "Pick or create a profile before the conversation starts; it cannot be changed afterwards",
	"当前任务运行中，无法切换 Profile":                    "A task is running; profiles cannot be changed",
	"当前任务运行中，无法新建 Profile":                    "A task is running; profiles cannot be created",
	"Profile 已锁定，当前会话不能更换":                    "Profile is locked; it cannot be changed in this session",
	"Profile 已锁定，当前会话不能新建":                    "Profile is locked; new profiles cannot be created in this session",
	"Profile 不在当前可用列表中":                       "Profile is not in the current catalog",
	"当前连接不支持新建 Profile":                       "Current connection does not support creating profiles",
	"Profile 名无效：不能为空、不能是 headless、不能包含路径分隔符": "Invalid profile name: must be non-empty, not headless, and contain no path separators",
	"同名 Profile 已存在，请直接选择":                    "A profile with this name already exists; select it directly",
	"Profile 设置已提交":                           "Profile setting submitted",
	"新建 Profile 已提交":                          "Profile creation submitted",
	...
	"查看并按会话开关技能":              "View and toggle skills for this session",
	"当前任务运行中，暂不能开关技能":         "A task is running; skills cannot be toggled",
	"当前任务运行中，无法开关技能":          "A task is running; skills cannot be changed",
	"已提交启用技能":                 "Skill enable request submitted",
	"已提交禁用技能":                 "Skill disable request submitted",
	"已刷新技能列表":                 "Skill list refresh submitted",
	"技能名无效":                   "Invalid skill name",
	"技能操作无效":                  "Invalid skill action",
