...
class UserAgreementContent {
  static const List<UserAgreementSectionData> sections =
    ...
    UserAgreementSectionData(
      ...
      paragraphKeys: <String>[
        'user_agreement_section_behavior_body_1',
      ],
      bulletKeys: <String>[
    ...
    UserAgreementSectionData(
      ...
      paragraphKeys: <String>[
        'user_agreement_section_minor_body_1',
      ],
      bulletKeys: <String>[
    ...
    UserAgreementSectionData(
      ...
      bulletKeys: <String>[
        'user_agreement_section_service_bullet_1',
      ],
    ),
    UserAgreementSectionData(
      titleKey: 'user_agreement_section_fee_title',
      paragraphKeys: <String>[
        'user_agreement_section_fee_body_1',
      ],
      bulletKeys: <String>[
    ...
    UserAgreementSectionData(
      ...
      paragraphKeys: <String>[
        'user_agreement_section_ip_body_1',
      ],
      bulletKeys: <String>[
